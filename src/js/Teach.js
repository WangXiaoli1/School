                            ...
                            {/*leader start*/}
                                <div className="leader">
                                    ...
                                    <div className="leader_one_r">
                                        <p>{this.data.leader_one_r1.txt1}</p>
                                        <p className="line"></p>
                                        <p>{this.data.leader_one_r2.txt2}</p>
                                        <p>{this.data.leader_one_r3.txt3}</p>
                                    </div>
                                    <div className="clear"></div>

                                    <div className="leader_two_l">
                                        <p>{this.data.leader_two_l1.txt1}</p>
                                        <p>{this.data.leader_two_l2.txt2}</p>
                                        <p className="line"></p>
                                        <p>{this.data.leader_two_l3.txt3}</p>
                                    </div>
                                    ...
                                    <div className="leader_three_r">
                                        <p>{this.data.leader_three_r1.txt1}</p>
                                        <p>{this.data.leader_three_r2.txt2}</p>
                                        <p className="line"></p>
                                        <p>{this.data.leader_three_r3.txt3}</p>
                                    </div>
                                    <div className="clear"></div>
